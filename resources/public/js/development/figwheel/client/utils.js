...
return (new CustomEvent(event_name,(function (){var obj31494 = ({"detail":data});
return obj31494;
})()));
} else {
...
var f = (function (){var pred__31501 = cljs.core._EQ_;
var expr__31502 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__31501.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__31502))){
return ((function (pred__31501,expr__31502){
return (function (p1__31495_SHARP_){
return console.warn(p1__31495_SHARP_);
});
;})(pred__31501,expr__31502))
} else {
if(cljs.core.truth_(pred__31501.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__31502))){
return ((function (pred__31501,expr__31502){
return (function (p1__31496_SHARP_){
return console.debug(p1__31496_SHARP_);
});
;})(pred__31501,expr__31502))
} else {
if(cljs.core.truth_(pred__31501.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__31502))){
return ((function (pred__31501,expr__31502){
return (function (p1__31497_SHARP_){
return console.error(p1__31497_SHARP_);
});
;})(pred__31501,expr__31502))
} else {
return ((function (pred__31501,expr__31502){
return (function (p1__31498_SHARP_){
return console.log(p1__31498_SHARP_);
});
;})(pred__31501,expr__31502))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__31505){
...
var eval_fn = cljs.core.get.call(null,map__31506__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__31508_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__31510,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1631323775312
