...
return (new CustomEvent(event_name,(function (){var obj27406 = ({"detail":data});
return obj27406;
})()));
} else {
...
var f = (function (){var pred__27413 = cljs.core._EQ_;
var expr__27414 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__27413.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__27414))){
return ((function (pred__27413,expr__27414){
return (function (p1__27407_SHARP_){
return console.warn(p1__27407_SHARP_);
});
;})(pred__27413,expr__27414))
} else {
if(cljs.core.truth_(pred__27413.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__27414))){
return ((function (pred__27413,expr__27414){
return (function (p1__27408_SHARP_){
return console.debug(p1__27408_SHARP_);
});
;})(pred__27413,expr__27414))
} else {
if(cljs.core.truth_(pred__27413.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__27414))){
return ((function (pred__27413,expr__27414){
return (function (p1__27409_SHARP_){
return console.error(p1__27409_SHARP_);
});
;})(pred__27413,expr__27414))
} else {
return ((function (pred__27413,expr__27414){
return (function (p1__27410_SHARP_){
return console.log(p1__27410_SHARP_);
});
;})(pred__27413,expr__27414))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__27417){
...
var opts = map__27418__$1;
var eval_fn = cljs.core.get.call(null,map__27418__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__27420_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__27422,(0),null);
...
}catch (e27427){if((e27427 instanceof Error)){
var e = e27427;
return not_found;
} else {
throw e27427;
...
//# sourceMappingURL=utils.js.map?rel=1612339727951
